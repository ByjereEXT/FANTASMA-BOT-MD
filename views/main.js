...
auth: state,
browser: ['Fantasma-MD','Firefox','1.0.0'],
}
...
await conn.sendHydrated(`68987707770@s.whatsapp.net`, `𝙷𝙾𝙻𝙰 𝐅𝐚𝐧𝐭𝐚𝐬𝐦𝐚𝐳ᙆ  ᷦ×͜×, 𝚂𝙴 𝙳𝙴𝚃𝙴𝙲𝚃𝙾 𝚀𝚄𝙴 𝙴𝚂𝚃𝙴 𝙽𝚄𝙼𝙴𝚁𝙾 𝙴𝚂 𝚄𝙽 𝙽𝚄𝙴𝚅𝙾 𝙱𝙾𝚃 𝙰𝙲𝚃𝙸𝚅𝙾 ✅`, author, pp, null, null, null, null, [['🌹 𝙾𝚆𝙽𝙴𝚁 🌹', '/owner'], ['👾 𝙼𝙴𝙽𝚄 𝙿𝚁𝙸𝙽𝙲𝙸𝙿𝙰𝙻 👾', '#menu']])
...
conn.bye = '*╔══════════════*\n*╟➢ @user*\n*╟➢ 𝙷𝙰𝚂𝚃𝙰 𝙿𝚁𝙾𝙽𝚃𝙾 👋🏻* \n*╚══════════════*'
conn.spromote = '*𝐀𝐓𝐄𝐍𝐂𝐈𝐎𝐍 𝐍𝐔𝐄𝐕𝐎 𝐀𝐃𝐌𝐈𝐍 𝐃𝐄𝐓𝐄𝐂𝐓𝐀𝐃𝐎 ⭐️ !!@user*'
conn.sdemote = '*𝐀𝐓𝐄𝐍𝐂𝐈𝐎𝐍 @user 𝐀𝐇 𝐏𝐄𝐑𝐃𝐈𝐃𝐎 𝐀𝐃𝐌𝐈𝐍!!*'
